...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/editor_jyotirmoy_13/", "_blank");
    }
    if (x == 2) {
        window.open("https://www.linkedin.com/in/jyotirmoy-adhikary-a15211242/", "_blank");
    }
    if (x == 3) {
        window.open("https://github.com/Jyotirmoy120", "_blank");
    }
    if (x == 4) {
